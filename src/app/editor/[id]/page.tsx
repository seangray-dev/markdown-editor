...
export default function EditorPage({ params }: { params: { id: string } }) {
  ...
  const id = params.id;
  const document = useQuery(api.documents.getDocumentById, { id: id });

  return (
    <>
      <Suspense fallback={<Header showEditorControls={false} />}>
        <Header showEditorControls={true} documentName={document?.title} />
      </Suspense>
      <main>
        {/* Toggle Section */}
